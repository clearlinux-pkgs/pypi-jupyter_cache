...
Source0  : https://files.pythonhosted.org/packages/bb/f7/3627358075f183956e8c4974603232b03afd4ddc7baf72c2bc9fff522291/jupyter_cache-1.0.1.tar.gz
...
%prep
%setup -q -n jupyter_cache-1.0.1
cd %{_builddir}/jupyter_cache-1.0.1
pushd ..
cp -a jupyter_cache-1.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731696043
