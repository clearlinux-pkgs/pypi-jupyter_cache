...
Source0  : https://files.pythonhosted.org/packages/69/64/08dcc1f6fc54a263525edd23b5d2754793470c1c41a8dd82d52406f8d876/jupyter-cache-0.6.1.tar.gz
...
%prep
%setup -q -n jupyter-cache-0.6.1
cd %{_builddir}/jupyter-cache-0.6.1
pushd ..
cp -a jupyter-cache-0.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682271737
...
cp %{_builddir}/jupyter-cache-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jupyter_cache/c79af3b2bce64932054ea3eafa76fba68456cde8 || :
